...
const timelineData = [
  ...
  },
  {
    ...
    images: [
      ...
      {
        src: "/assets/timeline/perwalianpkl2024.jpg",
        alt: "Perwalian PKL 2024",
      },
    ],
    quote:
  ...
  },
  {
    ...
    quote:
      "“Kini kita berdiri di ujung perjalanan sekolah, menyadari bahwa setiap langkah kita di sini adalah awal dari masa lampau yang akan dikenang selamanya.🏁”",
  },
];
  ...
  return (
    <div>
      ...
      <div>
        <section
          id="hero-section"
          className="relative min-h-dvh bg-gradient-to-t from-sky-50 to-transparent"
        >
          <div
          ...
          <div className="h-dvh w-full flex items-center">
            <header className="w-full">
              ...
              <div
                className="text-center md:pt-20 pt-16"
                data-aos="fade-up"
                data-aos-delay="200"
              ...
              >
                ...
                <p className="text-pretty px-4 md:w-1/2 w-full mx-auto text-sm text-sky-900 pt-3">
                  Tempat kumpulnya anak-anak keren yang suka ngoding, ngulik
                  teknologi, dan bikin project seru bareng. Di sini kita belajar
                  bareng, saling support, dan siap jadi programmer masa depan!
                </p>
                ...
                <div className="pt-8">
                  ...
                  >
                    ...
                    <span className="relative group-hover:text-slate-50 group-active:text-slate-50 transition-all ease-in-out md:duration-500 duration-300">
                      Instagram
                    </span>
                  </a>
                </div>
        ...
        <section id="arsip" className="py-8 mt-8 bg-slate-50">
          <div className="w-full pb-8 px-8 text-center">
            ...
            <p className="text-neutral-700 mb-4 dark:text-neutral-300 text-md md:text-lg max-w-2xl mx-auto text-center">
              Ada tawa di balik setiap potret, ada cerita di balik setiap
              ekspresi. Arsip ini bukan cuma gambar, ini memori yang kita bentuk
              bareng.
            </p>
          </div>
