  ...
  return (
    <div>
      ...
      <div>
        <section
          id="hero-section"
          className="relative h-dvh bg-gradient-to-t from-sky-50 to-transparent"
        >
          <div
          ...
          <header className="w-full">
            ...
            <div>
              <img
                src="/assets/Logo-rpl2.png"
                className="m-auto md:pt-20 pt-16"
                width={400}
                height={300}
                data-aos="zoom-in"
                data-aos-delay="100"
            ...
            <div
              className="text-center md:pt-24 pt-16"
              data-aos="fade-up"
              data-aos-delay="200"
              data-aos-duration="700"
            >
              <h1 className="md:text-4xl text-3xl px-4 tracking-tight font-bold text-sky-700">
                Selamat Datang di Kelas RPL 2
              </h1>
              <p className="text-pretty px-4 md:w-1/2 w-full mx-auto text-sm text-sky-900 pt-3">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. At,
                molestias nostrum id hic consequatur perspiciatis cumque sit
                architecto! Consectetur temporibus, laudantium officiis fugiat
                sapiente impedit commodi? Esse vitae quis asperiores!
              </p>
              ...
              <div className="flex gap-8 justify-center pt-4">
                <div className="flex items-center gap-1">
                  <div className="relative h-16 w-16 flex items-center justify-center gap-3">
                    <div
                      className="absolute h-14 w-14 border-2 bg-sky-500/30 border-sky-600  rounded-full border-dashed hover:animate-spin z-20"
                  ...
                  <p className="font-semibold">15 Siswa</p>
                </div>

                <div className="flex items-center gap-1">
                  <div className="relative h-16 w-16 flex items-center justify-center gap-3">
                    <div
                      className="absolute h-14 w-14 border-2 bg-pink-300/30 border-pink-400  rounded-full border-dashed hover:animate-spin z-20"
                      style={{ animationDuration: "10s" }}
                    ></div>
                    <div className="absolute items-center z-10">
                      <svg
                  ...
                  <p className="font-semibold">18 Siswi</p>
                </div>
              </div>

              <div className="pt-6">
                <button className="py-2 px-8 bg-slate-50 border-dashed border-sky-300 hover:border-sky-400 border-3 rounded-lg text-sky-500 font-semibold">
                  Instagram
                </button>
              </div>
            </div>
      ...
      <div>
        ...
        >
          ...
          <p className="text-neutral-700 mb-8 dark:text-neutral-300 text-md md:text-lg max-w-2xl mx-auto">
            Mereka telah merasakan langsung dampak luar biasa dari apa yang kami
            lakukan. Inilah suara dan pengalaman nyata dari mereka yang telah
