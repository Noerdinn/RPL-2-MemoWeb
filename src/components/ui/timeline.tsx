    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10 text-center">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-md md:text-lg max-w-2xl mx-auto">
         <span className="text-neutral-500 font-bold">KITA</span> telah melakukan banyak hal yang luar biasa dalam perjalanan ini. Pada akhirnya, kita telah berhasil mencapai titik akhir bersama-sama. Cheers 🍻
        </p>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="relative italic rounded-lg mx-3 md:mx-auto bg-white p-2 pt-6 bg-gradient-to-br from-white to-slate-50 border-2 border-slate-200  hover:border-sky-500 pl-20 pr-6 md:pt-8 md:pr-8 md:pl-8 w-full">
