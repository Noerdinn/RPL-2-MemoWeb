    ...
    >
      <div className="max-w-7xl mx-auto pt-20 pb-0 px-4 md:px-8 lg:px-10 text-center">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-md md:text-lg max-w-2xl mx-auto">
          <span className="text-neutral-500 font-bold">KITA</span> telah
          melakukan banyak hal yang luar biasa dalam perjalanan ini. Pada
          akhirnya, kita telah berhasil mencapai titik akhir bersama-sama.
          Cheers 🍻
        </p>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex justify-start pt-10 md:pb-10 md:gap-10"
          >
