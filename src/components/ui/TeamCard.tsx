...
const TeamCard: FC<TeamCardProps> = ({ name, text, image }) => {
  return (
    <div
      tabIndex={0}
      className="relative group bg-white rounded-xl p-4 w-full max-w-md border-2 border-gray-300 focus:border-blue-400 transition-all duration-300 text-gray-800"
      data-aos="fade-up"
      data-aos-delay="100"
    >
      ...
      <div className="absolute -top-5 left-1/2 transform -translate-x-1/2 z-10">
        <div className="relative w-12 h-12 flex items-center justify-center">
          <div
            className="absolute inset-0 rounded-full border-2 border-dashed border-sky-500 group-focus:animate-spin z-15"
